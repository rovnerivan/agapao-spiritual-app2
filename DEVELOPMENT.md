...
```bash
git remote add encore encore://agapao-spiritual-app-5332
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/agapao-spiritual-app-5332/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/agapao-spiritual-app-5332/settings/integrations/github)
